...
export default function VacancyCardPage({
  ...
  return (
    <section className="container flex flex-col items-center justify-center gap-5">
      ...
      />
      <section className="flex w-full flex-col items-center justify-center gap-6 overflow-hidden rounded-lg border border-[#f6c263] bg-[#f6c263] p-8 xl:h-96">
        <span className="self-start rounded-lg bg-[#f6c263] p-2 text-xs text-secondary">
