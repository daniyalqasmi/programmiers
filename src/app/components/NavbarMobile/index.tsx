    ...
    <>
      {modal && (
        <nav
          ...
          className={`absolute left-0 top-0 z-50 flex h-screen w-screen items-center justify-center bg-primary bg-gradient-to-b from-transparent to-[#f6c263] backdrop-blur-sm transition-all ease-in ${
        ...
        >
          <ul className="flex w-full transform flex-col items-center justify-center gap-8 overflow-hidden transition-all">
            <li className="m-2 w-full p-2 text-center transition-all hover:scale-105 hover:bg-secondary-800">
              <RouterLinks href="/" text="Home" onClick={closeModal} />
            </li>
