...
const VacancieDropdown = ({ handleCategorySelect }: VacancieDropdownProps) => {
  ...
  return (
    ...
    >
      <section>
        <Menu.Button className="inline-flex w-full items-center justify-between gap-x-1.5 rounded-md bg-[#f6c263] px-4 py-3 text-sm text-secondary shadow-sm hover:bg-zinc-900 md:flex xl:w-60">
