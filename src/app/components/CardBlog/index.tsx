...
export default function CardBlog({ date, image, title, id }: CardBlogProps) {
  ...
  return (
    <article
      ...
      className="flex h-96 w-64 flex-col items-center justify-between gap-6 overflow-hidden rounded-2xl border border-secondary-850 bg-[#f6c263] transition-all ease-in-out hover:cursor-pointer hover:border-[#f6c263] md:w-72 xl:w-80"
    >
      ...
      <section className="flex h-36 w-full flex-col items-start justify-center gap-8 p-6">
        ...
        <span className="text-base leading-5 text-[#f6c263]">{date}</span>
      </section>
    </article>
  )
}
