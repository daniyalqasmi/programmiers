...
describe('<VacancieInputFilter />', () => {
  it('should render the input field and label correctly', () => {
    ...
    expect(inputElement).toHaveClass(
      'w-full rounded-lg border border-[#f6c263] bg-[#f6c263] p-3 pl-12 text-start text-secondary outline-none transition-all ease-in placeholder:text-secondary focus:border-primary md:w-96',
    )
