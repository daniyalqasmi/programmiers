  ...
  return (
    <section className="relative w-full">
      <input
        ...
        className="min-w-96 w-full rounded-lg border border-[#f6c263] bg-[#f6c263] p-3 pl-12 text-start text-secondary outline-none transition-all ease-in placeholder:text-secondary focus:border-primary xl:w-[30rem]"
        value={value}
        onChange={onChange}
      />
