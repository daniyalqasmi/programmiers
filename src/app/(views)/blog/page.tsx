...
export default function Blog() {
  return (
    <section className="container flex flex-col items-center justify-center">
      ...
      <section
        key={PostsMock[1].id}
        className="mt-14 flex h-full w-full flex-col-reverse items-center justify-between overflow-hidden rounded-2xl bg-[#f6c263] xl:h-96 xl:flex-initial xl:flex-row xl:gap-8"
      >
        <article className="flex w-full flex-col items-center justify-between gap-2 p-6 xl:h-full xl:w-1/2">
          ...
          <Link
            ...
            className="self-end rounded-xl bg-[#f6c263] px-8 py-4 text-base font-bold leading-5"
          >
            Ler mais
          </Link>
        </article>
